...
const RemoveBackground: React.FC = () => {
    ...
    const AIInfoBox = () => (
        <div className="p-4 bg-black/70 text-gray-400 border border-zinc-800 rounded-lg text-sm">
            <p><span className="font-semibold text-[#1DB954]">Powered by AI:</span> This tool uses an API for high-quality results. Set your own key in settings for higher usage limits.</p>
        </div>
    );
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8">
                <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800 sticky top-24 space-y-4">
                    {!imageFile ? (
                        ...
                        <div className="bg-black/50 p-2 rounded-lg flex items-center justify-center min-h-[40vh] relative">
                            {isLoading && (
                                <>
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-300 bg-black/50">
